...
public:
    ...
    GizmoDrawMesh(Mesh* mesh, int submeshIndex, ObjPtr<Shader> shader, const glm::mat4& modelMatrix)
    ...
    void ProcessUserInput(Mesh* mesh, int submeshIndex, ObjPtr<Shader> shader, const glm::mat4& modelMatrix)
    {
        this->mesh = mesh;
