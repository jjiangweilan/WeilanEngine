...
namespace Engine
{
    ...
    bool AssetObject::Serialize(AssetSerializer& serializer)
    {
        return SerializeInternal("_root_", serializer);
    }
    ...
    void AssetObject::DeserializeInternal(const std::string& nameChain, AssetSerializer& serializer, ReferenceResolver& refResolver)
    {
    ...
    void AssetObject::DeserializePrivate(const std::string& nameChain, AssetSerializer& serializer, ReferenceResolver& refResolver)
    {
        for(auto& iter : editableMembers)
        {
            std::ostringstream oss;
    ...
    std::vector<RefPtr<AssetObject>> AssetObject::GetAssetObjectMembers()
    {
        return assetMembers;
    }
}
