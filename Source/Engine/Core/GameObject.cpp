...
namespace Engine
{
    ...
    RefPtr<GameScene> GameObject::GetGameScene()
    {
        return gameScene;
    }

    void GameObject::DeserializeInternal(const std::string& nameChain, AssetSerializer& serializer, ReferenceResolver& refResolver)
    {
