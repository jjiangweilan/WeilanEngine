...
public:
    ...
    Slang::Result CompileAndReflectProgram(
    ...
    )
    {
        ...
        Slang::ComPtr<slang::IBlob> diagnostics;
        Slang::Result result = SLANG_OK;

        Slang::ComPtr<slang::IModule> sourceModule;
        ...
        for (int i = 0; i < definedEntryPointCount; i++)
        {
            ...
            componentsToLink.push_back(Slang::ComPtr<slang::IEntryPoint>(entryPoint));
        }
