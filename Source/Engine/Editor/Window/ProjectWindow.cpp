...
{
    ProjectWindow::ProjectWindow(RefPtr<EditorContext> editorContext, RefPtr<ProjectManagement> projectManagement) : projectManagement(projectManagement), editorContext(editorContext)
    {
