...
bool EditorRegister::RegisterCustomExplorer()
{
    ...
    {
        customExplorers[typeInfo] = [](RefPtr<Object> object) { return MakeUnique<Explorer>(object); };
        return true;
    }
...
bool EditorRegister::RegisterInspector()
{
    ...
    {
        inspectors[typeInfo] = [](RefPtr<Object> object) { return MakeUnique<Inspector>(object); };
        return true;
    }
