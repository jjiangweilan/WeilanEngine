...
IMGUI_API ImVec2 GetSurfaceSize(); // get current window size
...
struct ImGuiIO
{
    ...
    float MouseWheelH; // Mouse wheel Horizontal. Most users don't have a mouse with a horizontal wheel, may not be
