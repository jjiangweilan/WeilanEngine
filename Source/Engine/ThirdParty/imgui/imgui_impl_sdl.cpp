        ...
        case SDL_WINDOWEVENT:
            {
                ...
                if (window_event == SDL_WINDOWEVENT_ENTER) bd->PendingMouseLeaveFrame = 0;
...
static bool ImGui_ImplSDL2_Init(SDL_Window* window, SDL_Renderer* renderer)
{
    ...
    if (SDL_GetWindowWMInfo(window, &info)) ImGui::GetMainViewport()->PlatformHandleRaw = (void*)info.info.win.window;
#else
    (void)window;
#endif
...
static void ImGui_ImplSDL2_UpdateMouseData()
{
    ...
    if (is_app_focused)
    {
        ...
        if (io.WantSetMousePos) SDL_WarpMouseInWindow(bd->Window, (int)io.MousePos.x, (int)io.MousePos.y);
