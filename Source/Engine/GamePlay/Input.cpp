...
void Input::PushEvent(SDL_Event& event)
{
    if (gameplayInput)
    {
        ...
        else if (event.type == SDL_JOYBUTTONDOWN || event.type == SDL_JOYBUTTONUP)
        {
            ...
            /*
    ps5: 0 x, 1 o, 2 sqaure, 3 triangle, 4 screenshot, 5 ps, 6 menu, 7 left joystick press, 8 right joystick press, 9
    L1, 10 L2, 11 up, 12 down, 13 left, 14 right, 15 central pad, 16 mute
               */
