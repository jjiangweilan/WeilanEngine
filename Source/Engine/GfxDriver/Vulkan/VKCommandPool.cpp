...
namespace Engine::Gfx
{
    ...
    {
        auto queue = static_cast<VKCommandQueue*>(gCreateInfo.queue.Get());
    ...
    std::vector<UniPtr<CommandBuffer>> VKCommandPool::AllocateCommandBuffers(CommandBufferType type, int count)
    {
        ...
        cmdAllocInfo.level = type == CommandBufferType::Primary ? VK_COMMAND_BUFFER_LEVEL_PRIMARY : VK_COMMAND_BUFFER_LEVEL_SECONDARY;
