...
VKInstance::VKInstance(const std::vector<const char*>& requiredExtension)
{
    ...
    if (enableValidationLayers)
    {
        ...
        if (CreateDebugUtilsMessengerEXT(this->vulkanInstance, &debugCreateInfo, nullptr, &this->debugMessenger) !=
            VK_SUCCESS)
        {
...
VkBool32 VKInstance::DebugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
                                   ...
                                   void* pUserData)
{
    ...
    {
        case VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT: SPDLOG_INFO(pCallbackData->pMessage); break;
        case VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT: SPDLOG_INFO(pCallbackData->pMessage); break;
        case VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT: SPDLOG_WARN(pCallbackData->pMessage); break;
        case VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT: SPDLOG_ERROR(pCallbackData->pMessage); break;
        default: break;
    }
...
VkResult VKInstance::CreateDebugUtilsMessengerEXT(VkInstance instance,
