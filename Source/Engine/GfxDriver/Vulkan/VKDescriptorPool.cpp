...
{
    VKDescriptorPool::VKDescriptorPool(RefPtr<VKContext> context, VkDescriptorSetLayoutCreateInfo& layoutCreateInfo) : context(context)
    {
    ...
    VKDescriptorPool::VKDescriptorPool(VKDescriptorPool&& other) :
        ...
        poolSizes(std::exchange(other.poolSizes, {})),
    ...
    std::size_t VKDescriptorPoolCache::VkDescriptorSetLayoutCreateInfoHash::operator()(const VkDescriptorSetLayoutCreateInfo& c) const
    {
        using std::size_t;
