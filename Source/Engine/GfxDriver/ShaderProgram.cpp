...
namespace Engine::Gfx
{
    ...
    bool ShaderConfig::operator==(const ShaderConfig& other) const noexcept
    {
        return cullMode == other.cullMode &&
            depth.writeEnable == other.depth.writeEnable &&
            depth.testEnable == other.depth.testEnable &&
            depth.compOp == other.depth.compOp &&
            depth.boundTestEnable == other.depth.boundTestEnable &&
            depth.minBounds == other.depth.minBounds &&
            depth.maxBounds == other.depth.maxBounds &&
            stencil.testEnable == other.stencil.testEnable &&
            stencil.front == other.stencil.front &&
            stencil.back == other.stencil.back &&
            color.blends == other.color.blends &&
            color.blendConstants[0] == other.color.blendConstants[0] &&
