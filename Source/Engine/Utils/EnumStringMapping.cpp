...
namespace Engine::Utils
{
    ...
    {
        if (str == "zero") return Gfx::BlendFactor::Zero;
        else if (str == "one") return Gfx::BlendFactor::One;
        else if (str == "srcColor") return Gfx::BlendFactor::Src_Color;
        else if (str == "oneMinusSrcColor") return Gfx::BlendFactor::One_Minus_Src_Color;
        else if (str == "dstColor") return Gfx::BlendFactor::Dst_Color;
        else if (str == "oneMinusDstColor") return Gfx::BlendFactor::One_Minus_Dst_Color;
        else if (str == "srcAlpha") return Gfx::BlendFactor::Src_Alpha;
        else if (str == "oneMinusSrcAlpha") return Gfx::BlendFactor::One_Minus_Src_Alpha;
        else if (str == "dstAlpha") return Gfx::BlendFactor::Dst_Alpha;
        else if (str == "oneMinusDstAlpha") return Gfx::BlendFactor::One_Minus_Dst_Alpha;
        else if (str == "constantColor") return Gfx::BlendFactor::Constant_Color;
        else if (str == "oneMinusConstantColor") return Gfx::BlendFactor::One_Minus_Constant_Color;
        else if (str == "constantAlpha") return Gfx::BlendFactor::Constant_Alpha;
        else if (str == "oneMinusConstantAlpha") return Gfx::BlendFactor::One_Minus_Constant_Alpha;
        else if (str == "srcAlphaSaturate") return Gfx::BlendFactor::Src_Alpha_Saturate;
        else if (str == "src1Color") return Gfx::BlendFactor::Src1_Color;
        else if (str == "oneMinusSrc1Color") return Gfx::BlendFactor::One_Minus_Src1_Color;
        else if (str == "src1Alpha") return Gfx::BlendFactor::Src1_Alpha;
        else if (str == "oneMinusSrc1Alpha") return Gfx::BlendFactor::One_Minus_Src1_Alpha;
    ...
    {
        if (str == "none") return Gfx::CullMode::None;
        else if (str == "front") return Gfx::CullMode::Front;
        else if (str == "back") return Gfx::CullMode::Back;
        else if (str == "both") return Gfx::CullMode::Both;
    ...
    {
        if (str == "add") return Gfx::BlendOp::Add;
        else if (str == "subtract") return Gfx::BlendOp::Subtract;
        else if (str == "reverseSubtract") return Gfx::BlendOp::Reverse_Subtract;
        else if (str == "min") return Gfx::BlendOp::Min;
        else if (str == "max") return Gfx::BlendOp::Max;
    ...
    {
        if ("never" == str) return Gfx::CompareOp::Never;
        else if ("less" == str) return Gfx::CompareOp::Less;
        else if ("equal" == str) return Gfx::CompareOp::Equal;
        else if ("lessOrEqual" == str) return Gfx::CompareOp::Less_or_Equal;
        else if ("greater" == str) return Gfx::CompareOp::Greater;
        else if ("notEqual" == str) return Gfx::CompareOp::Not_Equal;
        else if ("greaterOrEqual" == str) return Gfx::CompareOp::Greater_Or_Equal;
        else if ("always" == str) return Gfx::CompareOp::Always;
    ...
    {
        if ("keep" == str) return Gfx::StencilOp::Keep;
        else if ("zero" == str) return Gfx::StencilOp::Zero;
        else if ("replace" == str) return Gfx::StencilOp::Replace;
        else if ("incrementAndClamp" == str) return Gfx::StencilOp::Increment_And_Clamp;
        else if ("decrementAndClamp" == str) return Gfx::StencilOp::Decrement_And_Clamp;
        else if ("invert" == str) return Gfx::StencilOp::Invert;
        else if ("incrementAndWrap" == str) return Gfx::StencilOp::Increment_And_Wrap;
        else if ("decrementAndWrap == str") return Gfx::StencilOp::Decrement_And_Wrap;
